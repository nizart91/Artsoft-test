...
// Returns the public 'App\Admin\BookAdmin' autowired service.
...
include_once $this->targetDirs[3].'/src/Admin/BookAdmin.php';
...
$this->factories['App\\Admin\\BookAdmin'] = function () {
    $instance = new \App\Admin\BookAdmin('App\\Admin\\BookAdmin', 'App\\Entity\\Book', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Книги');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['App\\Admin\\BookAdmin.template_registry'] ?? $this->load('getBookAdmin_TemplateRegistryService.php')));
...
return $this->factories['App\\Admin\\BookAdmin']();
