...
// Returns the public 'App\Admin\AuthorAdmin' autowired service.
...
include_once $this->targetDirs[3].'/src/Admin/AuthorAdmin.php';
...
$this->factories['App\\Admin\\AuthorAdmin'] = function () {
    $instance = new \App\Admin\AuthorAdmin('App\\Admin\\AuthorAdmin', 'App\\Entity\\Author', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['App\\Admin\\AuthorAdmin.template_registry'] ?? $this->load('getAuthorAdmin_TemplateRegistryService.php')));
...
return $this->factories['App\\Admin\\AuthorAdmin']();
