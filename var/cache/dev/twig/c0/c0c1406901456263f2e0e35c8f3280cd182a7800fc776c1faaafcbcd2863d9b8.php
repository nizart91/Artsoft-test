...
class __TwigTemplate_32ea8a88d7b466b762dc501f78a848477797751afbbe362ab56fc3141ddbf6d4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_show_field($context, array $blocks = [])
    {
        ...
        ";
        // line 16
        if (twig_get_attribute($this->env, $this->source, ($context["elements"] ?? null), (isset($context["field_name"]) || array_key_exists("field_name", $context) ? $context["field_name"] : (function () { throw new RuntimeError('Variable "field_name" does not exist.', 16, $this->source); })()), [], "array", true, true, false, 16)) {
            // line 17
            echo "            ";
            echo $this->extensions['Sonata\AdminBundle\Twig\Extension\SonataAdminExtension']->renderViewElementCompare($this->env, twig_get_attribute($this->env, $this->source, (isset($context["elements"]) || array_key_exists("elements", $context) ? $context["elements"] : (function () { throw new RuntimeError('Variable "elements" does not exist.', 17, $this->source); })()), (isset($context["field_name"]) || array_key_exists("field_name", $context) ? $context["field_name"] : (function () { throw new RuntimeError('Variable "field_name" does not exist.', 17, $this->source); })()), [], "array", false, false, false, 17), (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 17, $this->source); })()), (isset($context["object_compare"]) || array_key_exists("object_compare", $context) ? $context["object_compare"] : (function () { throw new RuntimeError('Variable "object_compare" does not exist.', 17, $this->source); })()));
            echo "
        ";
        }
        // line 19
...
";
    ...
    {
        return array (  79 => 19,  73 => 17,  71 => 16,  68 => 15,  58 => 14,  35 => 12,);
    }
...
{% endblock %}
", "@SonataAdmin/CRUD/base_show_compare.html.twig", "/home/n/nizart2n/books4/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/base_show_compare.html.twig");
    }
}
