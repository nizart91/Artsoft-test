...
class __TwigTemplate_2e29e6dce851a38eefdfb7fd30be9f8c722f1e247d5d586d669799856dda50b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        // line 12
        return $this->loadTemplate(twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 12, $this->source); })()), "getTemplate", [0 => "base_list_field"], "method", false, false, false, 12), "@SonataDoctrineORMAdmin/CRUD/list_orm_many_to_many.html.twig", 12);
    }
    ...
    {
        return array (  210 => 42,  200 => 41,  190 => 38,  188 => 37,  184 => 36,  174 => 35,  163 => 32,  149 => 31,  145 => 30,  140 => 29,  122 => 28,  119 => 27,  105 => 26,  101 => 25,  98 => 23,  95 => 21,  93 => 20,  75 => 19,  72 => 18,  69 => 17,  59 => 16,  37 => 12,);
    }
...
{%- block relation_value -%}
    {{- element|render_relation_element(field_description) -}}
{%- endblock -%}
", "@SonataDoctrineORMAdmin/CRUD/list_orm_many_to_many.html.twig", "/home/n/nizart2n/books4/vendor/sonata-project/doctrine-orm-admin-bundle/src/Resources/views/CRUD/list_orm_many_to_many.html.twig");
    }
}
