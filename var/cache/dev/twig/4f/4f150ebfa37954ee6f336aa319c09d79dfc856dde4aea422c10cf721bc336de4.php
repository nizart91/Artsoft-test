...
class __TwigTemplate_dd3b5513e30bd9d658a4e9d936f4f2d4d52fbad0b39f501538bc9453fdb2bd8d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_tab_menu($context, array $blocks = [])
    {
        ...
        // line 37
        echo $this->extensions['Knp\Menu\Twig\MenuExtension']->render(twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 37, $this->source); })()), "sidemenu", [0 => (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 37, $this->source); })())], "method", false, false, false, 37), ["currentClass" => "active", "template" => $this->extensions['Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension']->getGlobalTemplate("tab_menu_template")], "twig");
...
";
    ...
    {
        return array (  199 => 46,  189 => 45,  179 => 37,  169 => 36,  159 => 33,  149 => 32,  135 => 28,  129 => 26,  126 => 25,  124 => 24,  114 => 23,  100 => 19,  94 => 17,  91 => 16,  89 => 15,  79 => 14,  57 => 12,  28 => 43,);
    }
...
{% block form %}
    {{ block('parentForm') }}
{% endblock %}
", "@SonataAdmin/CRUD/base_edit.html.twig", "/home/n/nizart2n/books4/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/base_edit.html.twig");
    }
}
