...
class __TwigTemplate_d299044467cf9cfc2b62115acc3401598fa70384c6c4f03792ab345408938507 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["sonata_admin"]) || array_key_exists("sonata_admin", $context) ? $context["sonata_admin"] : (function () { throw new RuntimeError('Variable "sonata_admin" does not exist.', 16, $this->source); })()), "edit", [], "any", false, false, false, 16) == "inline")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["field_description"]) {
                // line 18
                echo "        ";
                echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "children", [], "any", false, false, false, 18), twig_get_attribute($this->env, $this->source, $context["field_description"], "name", [], "any", false, false, false, 18), [], "array", false, false, false, 18), 'row');
                echo "
    ";
            }
...
{% endif %}
", "@SonataDoctrineORMAdmin/CRUD/edit_orm_one_to_one.html.twig", "/home/n/nizart2n/books4/vendor/sonata-project/doctrine-orm-admin-bundle/src/Resources/views/CRUD/edit_orm_one_to_one.html.twig");
    }
}
