...
class __TwigTemplate_991eac19da8d98b8c2dd78ce681eaec30f156d16e56079d003f65017490d7fac extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_field_row($context, array $blocks = [])
    {
        ...
        <div class=\"";
            ...
            <div class=\"";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 14, $this->source); })()), "box_class", [], "any", false, false, false, 14), "html", null, true);
            echo "\">
            ...
            // line 25
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 25, $this->source); })()), "fields", [], "any", false, false, false, 25));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
    ...
    public function block_show_title($context, array $blocks = [])
    {
        ...
        // line 18
        echo "                            ";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 18, $this->source); })()), "label", [], "any", false, false, false, 18), [], ((twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 18, $this->source); })()), "translation_domain", [], "any", false, false, false, 18)) ? (twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 18, $this->source); })()), "translation_domain", [], "any", false, false, false, 18)) : (twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 18, $this->source); })()), "translationDomain", [], "any", false, false, false, 18)))), "html", null, true);
        echo "
                        ";
    ...
    public function block_show_field($context, array $blocks = [])
    {
        ...
        echo "                                <tr class=\"sonata-ba-view-container\">
                                    ";
        // line 28
        if (twig_get_attribute($this->env, $this->source, ($context["elements"] ?? null), (isset($context["field_name"]) || array_key_exists("field_name", $context) ? $context["field_name"] : (function () { throw new RuntimeError('Variable "field_name" does not exist.', 28, $this->source); })()), [], "array", true, true, false, 28)) {
            // line 29
            echo "                                        ";
            echo $this->extensions['Sonata\AdminBundle\Twig\Extension\SonataAdminExtension']->renderViewElement($this->env, twig_get_attribute($this->env, $this->source, (isset($context["elements"]) || array_key_exists("elements", $context) ? $context["elements"] : (function () { throw new RuntimeError('Variable "elements" does not exist.', 29, $this->source); })()), (isset($context["field_name"]) || array_key_exists("field_name", $context) ? $context["field_name"] : (function () { throw new RuntimeError('Variable "field_name" does not exist.', 29, $this->source); })()), [], "array", false, false, false, 29), (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 29, $this->source); })()));
            echo "
                                    ";
        }
        // line 31
...
";
    ...
    {
        return array (  259 => 5,  256 => 4,  232 => 3,  221 => 31,  215 => 29,  213 => 28,  210 => 27,  200 => 26,  187 => 18,  177 => 17,  150 => 34,  136 => 33,  133 => 26,  116 => 25,  109 => 20,  107 => 17,  101 => 14,  95 => 13,  92 => 12,  89 => 11,  71 => 10,  52 => 9,  49 => 8,  46 => 2,);
    }
...
{% block field_row %}
    ...
    {% endfor %}
{% endblock %}
", "@SonataAdmin/CRUD/base_show_macro.html.twig", "/home/n/nizart2n/books4/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/base_show_macro.html.twig");
    }
}
